...
namespace BrainVR.Eyetracking.PupilLabs
{
    public static class PupilData
    {
        ...
        public static EyeData leftEye
        {
            get
            {
                if (!eyeData.ContainsKey(leftEyeKey)) eyeData.Add(leftEyeKey, new EyeData(SamplesCount));
        ...
        public static EyeData rightEye
        {
            get
            {
                if (!eyeData.ContainsKey(rightEyeKey)) eyeData.Add(rightEyeKey, new EyeData(SamplesCount));
        ...
        public static EyeData gazePoint
        {
            get
            {
                if (!eyeData.ContainsKey(gazePointKey)) eyeData.Add(gazePointKey, new EyeData(SamplesCount));
        ...
        public static EyeData leftGazeNormal
        {
            get
            {
                if (!eyeData.ContainsKey(leftGazeNormalKey)) eyeData.Add(leftGazeNormalKey, new EyeData(SamplesCount));
        ...
        public static EyeData rightGazeNormal
        {
            get
            {
                if (!eyeData.ContainsKey(rightGazeNormalKey)) eyeData.Add(rightGazeNormalKey, new EyeData(SamplesCount));
        ...
        public static EyeData leftEyeCenter
        {
            get
            {
                if (!eyeData.ContainsKey(leftEyeCenterKey)) eyeData.Add(leftEyeCenterKey, new EyeData(SamplesCount));
        ...
        public static EyeData rightEyeCenter
        {
            get
            {
                if (!eyeData.ContainsKey(rightEyeCenterKey)) eyeData.Add(rightEyeCenterKey, new EyeData(SamplesCount));
        ...
        {
            if (!eyeData.ContainsKey(key)) eyeData.Add(key, new EyeData(SamplesCount));
        ...
        {
            public static Vector3 GazePosition { get { return calculateMovingAverage ? gazePoint.Average : gazePoint.Raw; }}
            public static Vector3 LeftEyeCenter{get { return calculateMovingAverage ? leftEyeCenter.Average : leftEyeCenter.Raw; }}
            public static Vector3 RightEyeCenter { get { return calculateMovingAverage ? rightEyeCenter.Average : rightEyeCenter.Raw; }}
            public static Vector3 LeftGazeNormal {get { return calculateMovingAverage ? leftGazeNormal.Average : leftGazeNormal.Raw; }}
            public static Vector3 RightGazeNormal { get { return calculateMovingAverage ? rightGazeNormal.Average : rightGazeNormal.Raw; }}
        ...
        public class _2D
        {
            public static Vector2 LeftEyePosition {get { return calculateMovingAverage ? leftEye.Average : leftEye.Raw; }}
            public static Vector2 RightEyePosition { get{ return calculateMovingAverage ? rightEye.Average : rightEye.Raw; }}
            public static Vector2 GazePosition{get { return 0.5f * (LeftEyePosition + RightEyePosition); }}
            ...
            {
                if (_sceneCamera != null && _sceneCamera == sceneCamera) return ApplyFrustumOffset(GetEyeGaze(eyeID), eyeID);
